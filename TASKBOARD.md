...
|---|---|---|---|---|---|
| [S-003](specs/S-003-history-preserving-repository-consolidation/SPEC.md) | TK-001: Add a deterministic three-repo provenance manifest and read-only verifier (in-progress) | codex-engineer-dnd | none | TK-001 implementation and full local verification are green at a reviewable checkpoint. | Push the checkpoint and run an exact-head Auditor review before closing TK-001. |
| [S-005](specs/S-005-azlemzyk-canonical-campaign-data/SPEC.md) | TK-001: Inventory approved Azlemzyk sources and preview record counts/provenance without mutation (blocked) | Kayden (private-source scope); Campaign Data Engineer | S-004 | Domain/schema intent was verified; TK-001 is owner-blocked until Kayden authorizes exact private source paths after S-004. | Complete S-004 and record Kayden's approved private source paths, then move TK-001 to ready. |
