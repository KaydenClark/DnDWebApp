...
|---|---|---|---|---|---|
| [S-003](specs/S-003-history-preserving-repository-consolidation/SPEC.md) | TK-001: Add a deterministic three-repo provenance manifest and read-only verifier (in-progress) | codex-engineer-dnd | none | TK-001 exact-head Auditor findings were remediated with focused red/green coverage and full verification. | Push the remediation checkpoint and rerun the exact-head Auditor before closing TK-001. |
